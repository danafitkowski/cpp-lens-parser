...
| halfstep-fixture.xer | extracted from `test_half_step.py` `_make_xer()` | Half-step XER: 3 tasks (TK_Complete + TK_Active + TK_NotStart) with act_start/act_end/early_start/early_end fields populated. Tests progress field parsing and half-step logic isolation. |
